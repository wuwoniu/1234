...
/**
 *  @brief Returns the current mechanical rotor speed reference set for Motor 2, expressed in dHz (tenth of Hertz) 
 */
int16_t MC_GetMecSpeedReferenceMotor2(void)
{
	return MCI_GetMecSpeedRef01Hz( pMCI[M2] );
}

/**
 * @brief Returns the last computed average mechanical rotor speed for Motor 2, expressed in dHz (tenth of Hertz) 
 */
int16_t MC_GetMecSpeedAverageMotor2(void)
{
	return MCI_GetAvrgMecSpeed01Hz( pMCI[M2] );
}
...
/**
 * @brief returns Ia and Ib current values for Motor 2 in Curr_Components format
 */
Curr_Components MC_GetIabMotor2(void)
{
	return MCI_GetIab( pMCI[M2] );
}

/**
 * @brief returns Ialpha and Ibeta current values for Motor 2 in Curr_Components format
 */
Curr_Components MC_GetIalphabetaMotor2(void)
{
	return MCI_GetIalphabeta( pMCI[M2] );
}

/**
 * @brief returns Iq and Id current values for Motor 2 in Curr_Components format 
 */
Curr_Components MC_GetIqdMotor2(void)
{
	return MCI_GetIqd( pMCI[M2] );
}

/**
 * @brief returns Iq and Id reference current values for Motor 2 in Curr_Components format
 */
Curr_Components MC_GetIqdrefMotor2(void)
{
	return MCI_GetIqdref( pMCI[M2] );
}

/**
 * @brief returns Vq and Vd voltage values for Motor 2 in Volt_Components format
 */
Volt_Components MC_GetVqdMotor2(void)
{
	return MCI_GetVqd( pMCI[M2] );
}

/**
 * @brief returns Valpha and Vbeta voltage values for Motor 2 in Volt_Components format 
 */
Volt_Components MC_GetValphabetaMotor2(void)
{
...
{
	MCI_SetIdref( pMCI[M2], hNewIdref );
}
