...
#define VBUS_PARTITIONING_FACTOR      0.0909 /*!< It expresses how 
...
/*********** Bus voltage sensing section ****************/
#define VBUS_PARTITIONING_FACTOR2      0.0909 /*!< It expresses how 
                                                       much the Vbus is attenuated  
                                                       before being converted into 
                                                       digital value */
...
/******** Current reading parameters section ******/
/*** Topology ***/
#define THREE_SHUNT_INDEPENDENT_RESOURCES2

#define RSHUNT2                        0.050 

/*  ICSs gains in case of isolated current sensors,
        amplification gain for shunts based sensing */
#define AMPLIFICATION_GAIN2            5.00 
