...
/* Returns the current mechanical rotor speed reference set for Motor 2, expressed in dHz (tenth of Hertz) */
int16_t MC_GetMecSpeedReferenceMotor2(void);

/* Returns the last computed average mechanical rotor speed for Motor 2, expressed in dHz (tenth of Hertz) */
